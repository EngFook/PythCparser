...
class TestKeyword_define(unittest.TestCase):
    ...
    def test_define_twice_statement_with_different_spaces_of_define(self):
        a='''#define Str 10 + (
             # define Strtwo 20 * y'''
        """ #define
               |
    ...
    def test_define_twice_statement_with_different_spaces_of_define_2nd(self):
        a='''# define Str 10 + (
             #define Strtwo 20 * y'''
        """    #
               |
    ...
    def test_define_twice_statement_with_different_space_same_constantidentifier_2nd(self):
        a='''#define Str 10 + (
             # define Str 20 * y'''
        """    #
               |
    ...
    def test_define_twice_statement_with_different_space_same_constantidentifier(self):
        a='''# define Str 10 + (
             #define Str 20 * y'''
        """    #
               |
